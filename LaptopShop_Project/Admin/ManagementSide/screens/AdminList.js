      ...
      <TextInput
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            ...
            onPress={() =>
              {
                navigation.navigate('AdminDetails', {userId: item.id});
              }
            }>
              <View
        ...
        />
        <TouchableOpacity style={styles.button_style} onPress={() => navigation.navigate('AdminCreate')}>
